...
class AdminUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post admin_users_url, params: { admin_user: { email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, password: 'secret', password_confirmation: 'secret', username: @admin_user.username } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, password: 'secret', password_confirmation: 'secret', username: @admin_user.username } }
